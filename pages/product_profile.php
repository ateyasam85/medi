...
<body class="bg-gradient-to-br from-green-50 via-white to-green-100 text-gray-800">

<div class="max-w-4xl mx-auto mt-16 bg-white p-8 rounded-xl shadow-2xl transform transition-all duration-500 hover:scale-[1.01]">
  <div class="flex flex-col md:flex-row gap-10 items-center">
    ...
    <div class="md:w-1/2">
      <h2 class="text-3xl font-extrabold text-green-700 mb-4"><?= htmlspecialchars($productName) ?></h2>
      <p class="text-lg text-gray-700 leading-relaxed mb-6"><?= htmlspecialchars($product['description']) ?></p>
      <a href="index.php?page=product" class="inline-block px-5 py-2 bg-green-700 text-white font-semibold rounded hover:bg-green-800 transition">&larr; Back to Products</a>
    </div>
  </div>
</div>
