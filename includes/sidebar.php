<!-- MOBILE SIDEBAR -->
<div id="mobile-sidebar" class="fixed inset-y-0 left-0 w-64 bg-green-900 text-white transform -translate-x-full transition-transform duration-300 md:hidden z-50">
  <div class="p-4">
